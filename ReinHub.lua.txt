...
local Window = OrionLib:MakeWindow({Name = "REIN HUB", HidePremium = false, IntroText = "REINHUB Library", SaveConfig = true, ConfigFolder = "REIN HUB"})
...
OrionLib:MakeNotification({
	Name = "REIN HUB",
	Content = "REIN HUB Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
